...
RSpec.describe "/api/v1/rateios", type: :request do
  # This should return the minimal set of attributes required to create a valid
  # Api::V1::Rateio. As you add validations to Api::V1::Rateio, be sure to
  ...
  # Api::V1::RateiosController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Api::V1::Rateio.create! valid_attributes
      get api_v1_rateios_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Api::V1::Rateio" do
        expect {
          post api_v1_rateios_url,
               params: { api/v1_rateio: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Api::V1::Rateio" do
        expect {
          post api_v1_rateios_url,
               params: { api/v1_rateio: invalid_attributes }, as: :json
        }.to change(Api::V1::Rateio, :count).by(0)
      end

      it "renders a JSON response with errors for the new api/v1_rateio" do
        post api_v1_rateios_url,
             params: { api/v1_rateio: invalid_attributes }, headers: valid_headers, as: :json
